...
researchers, disseminate the results of this to the broader
community.&lt;br/&gt;&lt;br/&gt;The methods used, and problems studied, in this
project come from operator algebras (a branch of mathematics motivated by
quantum physics), group theory (the study of symmetry), and K-theory (a way of
measuring "twistedness" phenomena in geometry). The PI will study fundamental
classification problems in the theory of operator algebras by first solving
approximate versions; this uses intrinsically low-dimensional phenomena in the
structure of such objects, as recently revealed by other researchers. In
contrast, the PI intends to study high-dimensional obstructions to the existence
of approximate solutions to systems of matrix-equations governed by symmetry
groups. Finally, the PI intends to study the surprising analytic phenomena that
come up around the failure of exactness, and the connections of this to
