...
This project proposes several avenues of study regarding representations of
3-manifold groups. The PI will investigate the profinite completions of
hyperbolic 3-manifold groups. In particular, the PI will explore which
information about a 3-manifold may be extracted from the finite quotients of its
fundamental group, including hyperbolic volume and rank. The PI proposes to
investigate the dimension of the space of faithful irreducible representations
as the dimension of the representations increases. The PI plans to use right-
angled Artin groups and embeddings of 3-manifolds into them to investigate this
question. A related question is to investigate the growth of the number of
volumes of n-dimensional representations of hyperbolic 3-manifold groups as n
increases. Finally, the PI will investigate twisted-homology of hyperbolic taut
sutured 3-manifolds. In particular, the PI would like to find criteria for when
they are twisted SL(2,C)-homology products, motivated by the problem of
determining when twisted SL(2,C) Alexander polynomials detect the Seifert genus
(or more generally Thurston norm).
