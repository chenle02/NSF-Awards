* 8613807
* Functional Electrical Simulation of the Upper Extremity
* ENG,CBET
...
second set of electrodes will monitor the electrical activity produced by the
muscles and thus "sense" the degree of contraction or relaxation which
determines the position of the muscle, then use this information to control the
muscle movement; this, again is an instrumentation technique analogous to the
way in which the nervous system normally controls muscle movement. The unique
feature of this research is that the electrical stimulus to control the muscle
movement will use a range of frequencies simultaneously. The higher frequencies
can be used to inhibit muscle contraction; thus it is expected that a very fine
muscle response can be achieved. The result will be a more stable movement with
less fatigue than previously achieved.