...
optimal control and optimization problems.

The optimal control and structural optimization of systems described by partial
differential equations has a deep impact on the cost effective development of
technologically relevant devices and systems. Adaptive mesh refinement and
coarsening on the basis of efficient and reliable goal oriented a posteriori
error estimators is a significant algorithmic tool for numerical design studies
which contribute to improve the functionality of the devices and systems without
resorting to the cost intensive production of prototypes. The project will
introduce graduate students to both state-of-the-art optimization and numerical
simulation methods. The material will be used in graduate and undergraduate
courses.
