...
postdoctoral, graduate student, and undergraduate student levels.

Biochemical simulations of charged particle systems are often limited by the
cost of computing long-range electrostatic interactions. To address this issue
the PIs have developed a treecode-accelerated boundary integral (TABI) method to
solve the Poisson-Boltzmann (PB) equation for the electrostatic potential of a
