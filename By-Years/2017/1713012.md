...
applications in radiology and anthropology&lt;br/&gt;&lt;br/&gt;Geometric
concepts beyond Riemannian geometry and smooth manifolds will be leveraged to
develop novel statistical methodology to address complex challenges in data
analysis. Methods and tools, grounded on solid mathematical foundations, will be
developed for modeling complex objects (such as shapes and surfaces) and complex
relations within data (such as multi-commodity flow or aligning shapes). The
research will address two statistical challenges using geometric tools: (1)
