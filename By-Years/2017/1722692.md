...
recruiting new students, scientists, and faculty.

It is challenging to propose appropriate interface conditions for the new model
in order to couple the two flows in a physically valid way. Moreover, coupling
two constituent models leads to a complex system involving different scales in
the dual porosity flow and the free flow, which demands accurate and efficient
