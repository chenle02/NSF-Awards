...
This project will advance our understanding of high-dimensional and non-
parametric inference along three frontiers. Firstly, we aim to develop
statistical inferential tools for irregular models, which are valid under weak
conditions. Our particular focus will be on mixture models, and on methods which
use sample-splitting to avoid strong regularity conditions. Secondly, we will
show that our methods achieve these strong guarantees at a surprisingly small
statistical price. To rigorously quantify the statistical price paid for
avoiding strong regularity conditions we will use minimax theory. However,
standard minimax theory, in many cases, does not adequately capture the
...
and by developing and analyzing powerful new CI tests.
