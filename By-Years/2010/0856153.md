...
algorithms to handle more complex problems.&lt;br/&gt;&lt;br/&gt;This research
will make it possible to evaluate new energy generation and storage technologies
with far more realism than older models by properly accounting for uncertainties
and producing a more accurate estimate of the marginal value of different
technologies. We will gain a better understanding of the most important
parameters such as responsiveness, storage capacity and losses. This research
will also enhance our ability to develop robust policies to meet goals such as
20 percent renewable by 2030. A broader methodological benefit will be the
integration of the fields of stochastic programming and approximate dynamic
programming, which have evolved along parallel but separate paths with
distinctly different vocabularies, oriented toward different problem classes.