...
This grant is designed to integrate on-going measurements of magnetic field
fluctuations at conjugate locations (Iqaluit, Canada, and South Pole,
Antarctica) at high geomagnetic latitudes with other measurements to be carried
out under the GEM Program in order to obtain a more "global" description of the
dayside magnetopause environment. Of particular interest will be the study on a
"global" scale of magnetic impulse events, which appear to delineate regions of
localized magnetic field-aligned currents.