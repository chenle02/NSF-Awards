...
&lt;br/&gt;&lt;br/&gt;The project aims to develop new techniques based on recent
developments in martingale theory and analysis to investigate central limit
theorems, almost sure invariance principles (a strong form of approximation by
Brownian motion), large deviations, and other advanced statistics for a wide
class of non-equilibrium and random dynamical systems that are used to model
complex physical systems. Examples of the systems to be studied include billiard
systems (polynomially and exponentially mixing), models of intermittency,
Lorenz-like maps and flows, and systems arising from statistical mechanics.
Statistical properties of random dynamics can be investigated by sampling over
all noise realizations (annealed statistics) or along individual realizations of
the noise (quenched statistics). The project will also develop our understanding
of annealed and quenched statistical properties and the interplay between the
two.