...
nanoparticles used for this project.&lt;br/&gt;&lt;br/&gt;With funding support
from the Chemical Catalysis Program of the Chemistry Division, Dr. Yong Yan of
the New Jersey Institute of Technology is developing a novel photocatalytic
approach for carbon-carbon bond formation reactions using inexpensive lead
halide perovskite nanoparticles. APbX3 perovskite, where A is either
methylammonium or cesium and X is a halide, has displayed the potential to be an
efficient and cost-effective photovoltaic material. These perovskites also show
promise for photocatalytic organic synthesis due to their simple synthesis,
post-reaction processability, composition from earth-abundant elements,
exceptional photophysical properties, readily tunable conduction and valence
bands, and high catalytic turnover numbers. Although the instability of these
perovskites towards moisture hinders their application as photovoltaics,
...
nanoparticles used for this project.&lt;br/&gt;&lt;br/&gt;This award reflects
