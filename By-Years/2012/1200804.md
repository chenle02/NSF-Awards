...
combinatorial formulae for Gromov-Witten invariants of flag
manifolds.&lt;br/&gt;&lt;br/&gt;The investigation is largely fueled by extensive
computational experimentation. The robust implementation of algorithms derived
from the project will lead to the development of new packages for computer
algebra systems, which allow a user to build and manipulate computer
implementations of mathematical objects. The dissemination of this software,
through an open-source system, will not only advance the proposed research
