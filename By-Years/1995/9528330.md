...
GCD and Banerjee tests in general trapezoidal regions and perform an empi rical
...
all the data dependence analysis test's is essential to determining which tests
...
parallelizing compilers. By providing efficient and exact dependence analysis
