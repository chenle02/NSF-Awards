...
replace an undersize block to prolong the life of science instrument-handling
wire rope, interface radars with data from the ship's gyro for improved
navigation, acquire a van for the safe handling of radioisotopes, and obtain a
fax machine to improve communications.