...
* Cain Edie-Michell, University of California-San Diego
* Standard Grant
* Marian Bocea
* 10/31/2022
* USD 112,428.00
...
research projects.&lt;br/&gt;&lt;br/&gt;This project has two main goals. The
first is to classify type II quantum subgroups for many of the low rank Lie
algebras. This question is motivated by mathematical physics, where it is
equivalent to extending the Wess-Zumino-Witten conformal field theories. This
work builds on recent progress made by Terry Gannon. The second is to construct
and classify many new examples of bi-finite bimodules of von Neumann algebras.
This question is inspired by the classification of small index subfactors. As in
the subfactor classification, PI will uncover exotic
