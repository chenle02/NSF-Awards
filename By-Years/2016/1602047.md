...
&lt;br/&gt;&lt;br/&gt;This project investigates the arithmetic of hypergeometric
varieties and noncongruence modular forms. A majority of modular forms are
noncongruence in the sense that their symmetry groups cannot be described in
terms of congruences. The link between the two topics of study is manifest by
the fact that all algebraic curves defined over number fields can be realized as
modular curves of finite index subgroups of the modular group. Modular forms are
