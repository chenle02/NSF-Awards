...
&lt;br/&gt;&lt;br/&gt;The linear response eigenvalue problem is a major tool in
computing energy excitation states of electrons and molecules. This project will
critically advance current understanding and solution techniques for the
eigenvalue problem in the context of mathematical theory, computational methods,
and software. With the successful completion of the project, a significant
contribution will be made to the state-of-the-art physical excitation energy
computations via random phase approximations, a proven technique that is widely
used in computational quantum chemistry and physics.