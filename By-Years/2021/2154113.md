...
undergraduate levels.&lt;br/&gt;&lt;br/&gt;The project aims to contribute to new
developments in bilinear Fourier analysis through the investigation of a suite
of interrelated questions motivated by applications to analysis and partial
differential equations. The project will investigate several approaches, based
on tools including representations of functions, Littlewood-Paley techniques,
and symbolic calculus, to generate a host of new bilinear estimates and
boundedness properties of bilinear pseudodifferential operators. The results are
expected to apply to the pointwise multiplication properties of function spaces,
local well-posedness results for the Euler equations and the ideal
magnetohydrodynamic equations, and scattering properties of solutions of systems
of partial differential equations associated to local and nonlocal
