...
aims to establish new instances of these connections.&lt;br/&gt;&lt;br/&gt;The
fundamental problem at the heart of this project is to determine the arithmetic
nature of the special values of L-functions of an algebraic variety or motive
and to relate these values to the orders of algebraic quantities associated to
the variety or motive (such as a Chow group, a class group, or a Selmer group).
An important and motivating instance is the celebrated Birch and Swinnerton-Dyer
Conjecture for elliptic curves, vastly generalized by the Bloch-Kato
Conjectures. This project will extend progress toward this fundamental problem
through further development of connections between: L-functions, Galois
...
of representation theory to the existence Euler
