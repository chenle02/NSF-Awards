...
use techniques from his previous work to achieve these
goals.&lt;br/&gt;&lt;br/&gt;Three-manifolds are objects modeled on the
3-dimensional space that we are living in. A donut and the spatial universe are
both examples of 3-manifolds. These objects arise naturally in many contexts in
physical and other natural sciences and model many interesting phenomena. A
geometric way of studying 3-manifolds is to cut a complicated 3-manifold into a
pair of simpler 3-dimensional pieces called handebodies along a 2-dimensional
surface. This decomposition is called a Heegaard splitting. The PI plans to
study 3-manifolds using Heegaard splittings. The research targets several
central questions in low-dimensional topology and knot theory, which has
