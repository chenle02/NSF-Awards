...
To develop and test instructional materials and associated assessments, the
project joins efforts with the Concord Consortium and employs the Construct-
Centered Design process (a principled process based on evidence-centered
assessment and learning goal-driven designs); uses physical and computer-based
models and simulations; and draws on previous and ongoing work on a learning
progression of the hypothetical students' path in their understanding of the
structure, properties, interactions, and transformations of matter. Four
...
Key project outcomes include: (a) a research-informed and field-tested semester-
long course comprising four integrated units with specific objectives, learning
tasks, phenomena to illustrate and support understanding at key points, reading
