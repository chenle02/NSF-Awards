...
Fermat's Last Theorem.&lt;br/&gt;&lt;br/&gt;In this project, the extension
groups to be analyzed are Selmer groups. The PI will develop techniques for
studying the deformation theory of reducible representations by systematically
using pseudorepresentations. In this case, explicit deformations come from
congruences between Eisenstein series and cuspidal modular forms. Analysis of
deformations leads to results relating the size of Selmer groups to special
values of L-functions, as predicted by the Bloch-Kato conjectures. Of particular
interest are refined conjectures, such as Sharifi's conjecture, which extract
finer information about Selmer groups from more delicate properties of
congruences.&lt;br/&gt;&lt;br/&gt;This award reflects NSF's statutory mission
