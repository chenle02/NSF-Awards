...
&lt;br/&gt;&lt;br/&gt;Convex bodies appear as objects of study in many areas of
Mathematics, and have applications in Physics, Medicine, and Computer Science.
For example, the problem of reconstructing a three dimensional body from one and
two dimensional information is the basis of medical techniques such as X-rays
and CT-scans, and it is also used in the study of the structure and physical
properties of crystals. Convexity holds central importance in optimization and
linear programming problems. This project works towards the advancement of the
