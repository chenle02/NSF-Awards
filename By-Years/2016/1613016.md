...
that allow a better understanding of the underlying asset price
formation.&lt;br/&gt;&lt;br/&gt;The principal investigator will tap on the
previously mentioned needs and is expected to significantly advance the area in
the following three primary directions of theoretical and practical relevance:
(1) Devise new methodologies towards the implementation of "optimal" inference
methods in regard to the intrinsic tuning parameters of the methods; (2) Develop
a new approach, together with the necessary theoretical foundations, for
adaptive estimation methods based on data-driven fixed point procedures; (3)
Better incorporation of Limit Order Book data in the modeling of both the
underlying approximating jump-diffusion process and the microstructure noise
with a view of enhancing the estimation of latent process parameters based on
