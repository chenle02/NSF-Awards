...
better results for many massive data analysis tasks.&lt;br/&gt;&lt;br/&gt;To
ensure that the work is grounded in an important application, the PIs will focus
on computer vision, an area where Internet-scale datasets are having a
...
include graduate training in both algorithms and image
processing.&lt;br/&gt;&lt;br/&gt;For further information see the project web
site at: http://cs.brown.edu/~pff/SNN/