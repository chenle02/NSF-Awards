...
throughout the country. We propose to harness this new technological resource as
a teaching tool for specific topics in math and science, focusing on random
processes in nature and their deep connection to concepts in probability and
fractal geometry. Such natural phenomena as the growth of snowflakes via random
...
process of "doing science" with both hands-on experiments and computer
simulations, students will learn abstract mathematical concepts in a context
which is at once concrete and inherently motivating. Furthermore, the techniques
