...
fundamental importance, the interactions remain poorly
understood.&lt;br/&gt;&lt;br/&gt;The project will: (1) Determine properties of
Homestake rocks: geological, geochemical, mechanical, thermal, isotopic, and
reactivity. (2) Upscale these data to elucidate transport mechanisms (conductive
versus convective), natural reaction rates in fractures, and microbial community
evolution. (3) Evaluate monitoring strategies, in-situ probes and sampling
methods, and necessary measurements. (4) Select a candidate site for the
evaluating coupled processes. (5) Develop a work-breakdown-structure. (6)
Develop a coupled numerical model to evaluate potential effects on the rock mass
and optimal heater configuration, power, and monitoring borehole
orientations.&lt;br/&gt;&lt;br/&gt;The models and insight from these experiments
will have broad applicability to engineered systems, e.g., enhanced geothermal
systems, CO2 sequestration and subsurface contaminant transport. Educational
outreach will involve facility tours and a traveling benchscale ?mock-up?
