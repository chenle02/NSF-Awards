...
properties.&lt;br/&gt; &lt;br/&gt;A dynamical system here stands for an abstract
set of points together with an evolution law which governs the way points move
over time. It turns out that many problems concerning simultaneous approximation
of real numbers by rational numbers can be understood in terms of the behavior
of certain orbits. Furthermore, systems that arise in this context are of
algebraic nature, which makes it possible to use a wide variety of sophisticated
tools for their investigation. The educational aspect of the proposal involves
exposing graduate and undergraduate students to new methods and techniques in
number theory and dynamical systems, and supervising research projects of high
school students within the framework of the PRIMES program.