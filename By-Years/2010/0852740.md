...
analysis system will target biomarkers for &lt;br/&gt;oxidative stress using
biofluids which mimic cerebrospinal fluid (CSF). &lt;br/&gt;The coupling of
micro/nano fluidic sample preparation to miniature atmospheric pressure mass
spectrometers offers much value to the biological sciences, for example making
it possible to realize real-time functional assays of changes in fundamental
metabolic, regulatory and signaling processes in response to environmental
factors. Fundamental improvements in the performance of mass spectrometers and
in microfluidic devices will result from the synergy of this project, making
