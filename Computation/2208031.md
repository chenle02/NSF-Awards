...
engagement in various outreach activities.

The project focuses on the development of a mathematical framework, tools, and
algorithms for sampling and reconstruction of time-evolving functions on graphs.
The investigators will solve several inverse problems such as the recovery of an
