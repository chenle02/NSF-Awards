...
providing for a vigorous mentoring program.&lt;br/&gt;&lt;br/&gt;Many
conservative models have Hamiltonian structures. One goal of this proposal is to
find an instability index formula for Hamiltonian PDEs with an indefinite energy
functional, including gravity water waves, ion acoustic wave equations and
Vlasov models for collisionless plasmas. The second goal is to find stability
criteria (particularly turning point principles) for several stellar models
including rotating and magnetic stars, neutron stars and relativistic galaxies.
The third goal is to understand the long-time dynamics near linearly stable
Bernstein–Greene–Kruskal (BGK) waves for the one-dimensional Vlasov-Poisson
