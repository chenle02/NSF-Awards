...
This award will provide support for data collection efforts in Houston, Texas in
the aftermath of Hurricane Harvey with several research objectives in mind: (1)
to understand the organizational dynamics associated with volunteer intake and
assignment; (2) to create and validate analytical models for volunteer intake
and service length; (3) to understand the barriers to successful incorporation
of spontaneous volunteers into the emergency response to disasters. The PIs will
collect data from a number of groups involved in the relief effort, including
religious organizations, local businesses, ad-hoc groups, and traditional relief
agencies. The PIs will observe activities in active relief operations, interview
relief staff and volunteers, and collect and analyze volunteer logs and disaster
management systems. These data will provide valuable input for predictive models
for volunteer convergence.