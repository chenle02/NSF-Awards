...
principal investigator aims to utilize tools from classical Diophantine analysis
and modern applications of analytic number theory and arithmetic geometry to
study basic arithmetic structures. This work will combine ideas from the
geometry of numbers with both algebraic and analytic tools to study problems
such as representation of integers by binary forms and orders in number fields,
as well as various problems about heights in number
