...
for the study of quantum information theory.&lt;br/&gt;&lt;br/&gt;Continued
reduction of the size of components in computers necessarily leads to a
consideration of quantum mechanical effects and, potentially, to the development
of a computer that can solve problems inaccessible to current technology. An
important aspect of developing the required technology is the detection and
measurement of putatively entangled states in the laboratory. A key goal of this
project is to relate the mathematical theory directly to the design of
laboratory protocols for the detection of such entanglement. In addition,
greater insight into the nature of entanglement will suggest both new
