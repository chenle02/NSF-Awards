...
* DMS,STATISTICS
* 07/01/2013,06/20/2013
* Jay Bartroff,CA,University of Southern California
* Standard Grant
* Gabor Szekely
* 06/30/2017
* USD 150,000.00
...
The project will provide new statistical methods to handle the analysis of
multiple data streams arriving sequentially over time in a coherent fashion. The
need to handle this type of data arises in a plethora of real-world situations
including terrorist threat detection, quality control, finance, biomedical
clinical trials for new treatments, disease monitoring in human and animal
populations, genetics, and genomics. Despite this, there are few existing
statistical procedures that one can use except in some special cases. The
procedures developed in this project will therefore be widely applicable by
scientists and workers in these areas. Methodologically, the work will be a
breakthrough in a fundamental yet largely unexplored area of statistics, with
many benefits and broader impacts to society.
