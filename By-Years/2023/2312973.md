...
Personal data, such as health Internet of Things (IoT) data, nowadays is
possessed by service providers’ central data centers, and individuals do not
have ultimate control over the data they produce. This is a growing concern due
to the sensitive nature of such user-generated data. The proposed Web 3.0-based
data infrastructure is an evolution of the current centralized data ecosystem,
aiming to address some of its limitations and challenges. This project aims to
build a zero-trust and traceable data-sharing ecosystem Web3DB, where data
ownership and control are returned to the individuals who generate the data. In
Web3DB, the data owners will be able to define the data access and sharing
policy that will be enforced in a zero-trust manner, i.e., without relying on
central coordinators or infrastructure. During such access control, users’
identities and credentials will always remain encrypted for their privacy.
Access and usage of individuals’ data will be logged securely such that only the
data owners can monitor the access and usage of their data. Furthermore, this
research will support the development of a diverse cohort of Ph.D.,
