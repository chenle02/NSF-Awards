...
Processing of Temporally-Coded Auditory Representations for Sound Separation and
Localization&lt;br/&gt;&lt;br/&gt;The proposed work investigates the use of two
...
temporal representations of input signals will be used. These are 1) phase-
locked spike train responses in a simulated auditory nerve array (Auditory
Temporal Images), and 2) an auditory-inspired signal representation based on
adaptive demodulation (Adaptive Demodulation and Real-Zero Conversion) that
converts bandpass signals into timings of certain zero
