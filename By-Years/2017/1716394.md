...
&lt;br/&gt;&lt;br/&gt;The investigators will carry out two closely related
projects to model the gravitational wave astrophysics of compact binary systems.
The first project concerns the astrophysical information that can be extracted
from the characteristic signature imposed on a gravitational wave signal due to
the spin and the orbital precession of coalescing black hole binaries. The team
will introduce spin dynamics into compact binary evolution models and track the
