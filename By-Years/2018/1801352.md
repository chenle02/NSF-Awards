...
groups, that is matrix groups over p-adic fields. &lt;br/&gt; &lt;br/&gt;Roughly
speaking, the category of representations of a reductive p-adic group is dual to
the cocenter of its Hecke algebra. The PI has established the Newton
decomposition of the cocenter of this Hecke algebra, based on some recent
discoveries about Weyl groups. This research will systematically develop
consequences of this decomposition. Results will have applications in many
directions in the theory of representations of reductive p-adic groups. More
precisely, the PI plans to describe the relationship between the cocenter and
the orbital integrals; the relationships between cocenters of different groups
arising from base change and inner forms; and the relationships between the
cocenter and the mod-l representations.&lt;br/&gt;&lt;br/&gt;This award reflects
