...
* DMS,STATISTICS
* 06/01/2012,05/29/2012
* Yijian Huang,GA,Emory University
* Standard Grant
* Gabor Szekely
* 05/31/2016
* USD 180,000.00
...
censored quantile regression methodology. Time-to-event data arise in survival
studies from a wide range of fields including biomedical sciences, engineering,
economics, sociology, public health, and demography. Scientific questions of
interest are often concerned with how survival time might be affected by
covariates, i.e., predictors; for instance, whether HIV-infected individuals may
survive longer with a new intervention. Standard survival analysis techniques,
as routinely adopted, presume constant effects of covariates over time. Such a
practice has contributed to many scientific controversies in circumstances where
effects of interest may evolve over time. This research tackles the problem by
adopting censored quantile regression, which accommodates varying effects of
covariates in a realistic and robust fashion. The proposed developments will
complement standard survival analysis techniques and have the potential to
substantially influence survival analysis in practice.
