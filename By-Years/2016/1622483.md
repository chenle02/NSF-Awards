...
interdisciplinary research project.&lt;br/&gt;&lt;br/&gt;The primary statistical
challenges in modeling these irregular, multi-scale and multi-dimensional
spatio-temporal processes will be addressed using a functional data approach.
Computational techniques and theoretical machinery will be developed for
simultaneous model selection and inference in functional data and in non-
parametric and semi-parametric models involving such data. Computation-based
procedures will be developed for testing goodness of fit of models for
