...
expand outreach activities to local K-12 classrooms.

The PI will study Thurston maps, braid groups, and mapping class groups. A
Thurston map is a branched cover of the complex plane (or Riemann sphere) over
itself, with finite post-critical set. Many polynomials are Thurston maps. A
basic recognition problem in complex dynamics is: given a Thurston map, is it
...
into the relationships between polynomials of different degrees.
