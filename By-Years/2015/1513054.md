...
Deepwater Horizon disaster. &lt;br/&gt;&lt;br/&gt;This project is an attempt to
place completely integrable nonlinear wave equations on a similar footing as
constant-coefficient linear equations, from the point of view of asymptotic
analysis (i.e., to further develop nonlinear analogues of the classical methods
of stationary phase and steepest descent for integrals). The specific problems
to be addressed include the study of the inverse-scattering transform for the
Benjamin-Ono equation (a nonlocal integrable model for internal gravity waves)
in the small-dispersion limit, the study of the resonant interaction of wave
packets through a quadratic nonlinearity in the semiclassical limit, the study
of an analogue of the defocusing nonlinear Schroedinger equation describing
waves in two spatial dimensions in the semiclassical limit, the study of
dynamical stability of so-called rogue waves, the study of mixed
initial/boundary-value problems for integrable equations in the semiclassical
limit, and the investigation of "universal wave patterns", analogues to wave
propagation problems of universal phase transitions in statistical mechanics and
