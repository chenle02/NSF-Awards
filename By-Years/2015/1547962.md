...
detection in disease diagnosis. &lt;br/&gt;&lt;br/&gt;Structural DNA
nanotechnology currently faces a similar bottleneck in the broad participation
of designers due to the need for automated CAD-based design software for these
nano-objects. Here, development of a next-generation CAD framework is proposed
to enable the fully automated design of structured DNA assemblies at the
nanometer scale. As a starting point, the development of a CAD program is
proposed here for the synthesis of a unique class of DNA-based objects called
DNA nanocages. DNA nanocages can be programmed to adopt nearly arbitrary
symmetries and sizes on this scale. Further, these DNA-based particles may be
functionalized chemically with proteins, RNAs, chromophores, and other small
molecules for diverse applications in biomolecular science and technology. In
addition, these nanoscale materials can be transformed into structured inorganic
materials including metals and silicon dioxide. To realize the aim of
