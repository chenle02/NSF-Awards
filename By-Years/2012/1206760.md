...
continue to work.&lt;br/&gt;&lt;br/&gt;Quasi-isometric and bilipschitz geometry,
which allows a limited amount of deformation, provides a framework in which
geometries which would otherwise depend on choices become unique. This framework
is useful both in the large, e.g., for the geometric study of universal covers
of compact manifolds, where it connects geometry/topology with geometric group
theory, and in the small, where it is the natural framework for the study of the
local geometry of algebraic sets. In both situations three-dimensional manifolds
play an important role. Moreover, through invariants of manifolds one has
interactions of low dimensional topology with algebra, number theory, and
theoretical physics. Using these approaches the project addresses long-term open
theoretical questions that span different areas of mathematics. Links between
disparate areas provide much of the power of mathematics, and strengthening
