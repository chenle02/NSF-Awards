...
This grant is to use a large statistical database of precipitating particle data
(developed by the PI) to produce mapping of ionospheric signatures of
magnetospheric boundary processes.