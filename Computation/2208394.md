...
organized to exchange ideas relevant to this project.

New computational approaches will be developed for training machine learning
models on a cluster of computing nodes as well as solving decentralized multi-
agent optimization problems that have the capacity to handle coupling
constraints. The main goal is to design fast-convergent and communication-
efficient optimization methods with theoretical guarantees for solving large-
scale distributed machine learning problems. Accelerated compressed proximal
stochastic gradient methods will be designed for distributed composite smooth
stochastic problems, accelerated compressed stochastic subgradient methods will
be designed for distributed nonconvex nonsmooth problems, optimal decentralized
stochastic gradient methods will be designed for solving multi-agent
optimization with nonlinear coupling constraints, and asynchronous
implementations will be performed in the proposed methods in order to have high
