...
(non asymptotic) point of view.&lt;br/&gt;&lt;br/&gt;Sequential allocation in
dynamic environments is a problem that arises at the intersection of
nonparametric statistics, machine learning and operations research. This project
involves techniques from these fields and points out fundamental bridges between
the extant results to form a more unified theory of the subject. This theory
will then serve as a basis for producing computationally efficient allocation
policies with potential applications in clinical trials, drug discovery and real
time web page content optimization.&lt;br/&gt;