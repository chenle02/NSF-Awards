...
connectivity using multi-subject data.&lt;br/&gt;&lt;br/&gt;The overarching goal
of this research is the development of new statistical methodologies for
analyzing data that has both a time and space dimension. Spatio-temporal data
are prevalent in many disciplines, including the environmental and soil
sciences, meteorology and oceanography, neuroscience and the emerging fields of
health and bioterrorism surveillance. The primary data source for the
investigators is time-sequenced data of brain activity measured at many
locations in the brain. These signals contain information on how the brain
functions, how it responds to outside stimuli, and where synchronization of
functionality occurs. The statistical models the investigators are developing
