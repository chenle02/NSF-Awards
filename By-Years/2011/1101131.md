...
occur abundantly in a variety of situations of geometric
interest.&lt;br/&gt;&lt;br/&gt;Commutative algebra allows one to encode
information regarding solution sets of polynomial equations into objects such as
rings and modules, and further understand their structure, using algebraic tools
and a recent infusion of techniques from other fields that deal with physical
spaces, such as topology. This method of encoding information and its further
study is relevant to almost any area of mathematics, and to theoretical physics.
In particular, the classes of rings and the properties considered in this
project are relevant in the field of algebraic geometry, and some of the methods
and outcomes make connections with the field of non-commutative algebra.