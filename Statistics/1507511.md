...
Various algorithms have been proposed and analyzed to understand the underlying
generating mechanism of networks, called graphon, and to do community detection.
Many consistency results are obtained. Despite these recent methodological and
theoretical progresses on graphon estimation and community detection, especially
on stochastic block model, there have been little fundamental studies on optimal
