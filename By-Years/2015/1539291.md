...
environments. &lt;br/&gt;&lt;br/&gt;MBVL will address multi-scale, heterogeneous
data challenges with informatics solutions that enable the cyber-generation and
documentation of biodiversity indicators, providing the traceability between
data and information to be used as a basis for sustainable ecosystem-based
management and needed policy decisions. Thus researchers and students will be
further engaged to think and act at the system-level. The research will have
impacts beyond ocean sciences, i.e. more broadly in management and policymaking
regarding marine resources and ecosystem services via key links with fisheries
managers enabled by collaborations external to this project and with industry
partners to evaluate and disseminate solutions to a much wider user base.