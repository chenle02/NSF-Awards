...
receive training to contribute towards these projects.&lt;br/&gt;&lt;br/&gt;The
primary goal of the Principal Investigator's project is to prove new relations
between special cycles and automorphic forms. For example, the Principal
Investigator will use recent advances in the theory of Borcherds products and
integral models to prove the modularity of generating series formed from special
cycles of arbitrary codimension on integral models of orthogonal Shimura
varieties. The Principal Investigator will also prove new examples of
...
kernels for automorphic L-functions.&lt;br/&gt;&lt;br/&gt;This award reflects
