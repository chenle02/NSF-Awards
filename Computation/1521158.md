...
To cope with their shortcomings and to also understand RBFs at a more
fundamental level, the PI will intensively study RBF-substitutes: these are
products of polynomials with Gaussians, equivalent to extending the infinite
interval basis of Hermite functions to interpolation and PDE-solving on a finite
interval. Earlier work of the PI established a rigorous convergence-and-error
theorem and also numerical comparisons showing the superiority of Hermite
functions to RBFs in some applications. Conventional single-domain
