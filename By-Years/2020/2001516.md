...
activity.&lt;br/&gt;&lt;br/&gt;In more detail, the first project originated from
the Grothendieck-Serre conjecture on principal bundles, which was settled
recently for rings containing fields by Ivan Panin and the PI. The PI plans to
extend the proof to the mixed characteristic case as well as to work on the
purity conjecture for principal bundles. The purity conjecture is, in a sense,
the next logical step after the Grothendieck-Serre conjecture. In the second
project, the PI intends to construct and prove the local Langlands duality for
Hitchin systems and to derive some cases of the global Langlands duality for
Hitchin systems from the local case. The third project is devoted to counting
motivic volumes of moduli stacks of principal Higgs bundles. The goal is to
generalize the previous results of the PI and other people from the GL(n) case
to the case of arbitrary reductive groups.&lt;br/&gt;&lt;br/&gt;This award
