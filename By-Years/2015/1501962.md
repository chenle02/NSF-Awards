...
with other parts of mathematics and related areas. &lt;br/&gt;&lt;br/&gt;Several
of the main problems under study are concerned with understanding the extent to
which various classical facts and theorems remain true in a random setting; for
example: (a) When (i.e., for what p = p(n)) is the "clique complex" (whose
simplices are the vertex sets of the cliques) of the random graph G(n,p) likely
to have vanishing k-dimensional homology (e.g., over the integers or the
