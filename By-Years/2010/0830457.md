...
questions such as:&lt;br/&gt;What are fundamental limits on storage and
processing of structural information? What are fundamental bounds on extraction
of information from large biological databases? Lack of understanding of such
questions threatens to raise severe impediments to further advances in science
and engineering of complex systems. The main goal of this work is to search for
measures and algorithms to appraise the amount of organization and structure
embodied in artifacts and natural objects.&lt;br/&gt;We propose to make headway
in information theory of data structures.&lt;br/&gt;&lt;br/&gt;Data is
increasingly available in various forms (e.g., sequences, expressions,
...
information conveyed in (i).&lt;br/&gt;&lt;br/&gt;