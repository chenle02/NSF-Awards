...
automorphism tower problem, using set theoretic
techniques.&lt;br/&gt;&lt;br/&gt;Mathematical logic provides tools of great
generality which can be applied to various areas of mathematics. In
combinatorial contexts the model theoretic point of view provides methods that
can be used to handle specific problems very uniformly, rather than on the case
by case basis sometimes encountered in the literature. Descriptive set theory
provides methods for analyzing the relative difficulty of both solved and
unsolved problems in algebra, and in particular provides concrete information as
to how detailed an answer one may usefully seek in a classification problem,
making it possible to distinguish dead ends from fruitful lines of inquiry on an
a priori basis. &lt;br/&gt;