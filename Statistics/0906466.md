...
statistical methodology based on those results.

Statistical methods are used in a wide range of fields. In particular,
likelihood-based methods have been used in in applications ranging from the
reliability of computer software to the analysis of genetic data. Much of
current statistical theory is restricted to relatively simple models, in which
the available data is large relative to the number of unknown parameters in the
model. However, in complex models, it may be necessary to estimate a large
number of parameters based on relatively little data. This research will develop
statistical theory and methodology for this type of model and these results will
lead to improved statistical methods that will be useful in many areas of
application. The research will also further our understanding of the properties
of statistical models and, hence, will be useful in the training of researchers
