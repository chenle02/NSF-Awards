...
The PI will study problems with pointwise controls and/or state constraints.
These problems are usually modeled by Dirac delta functions in the source term,
and control and state variables are in some nontrivial admissible sets. Analysis
of such problems is challenging due to low regularity of solutions of the state
