...
* Kimberly Coble, Chicago State University
* Standard Grant
* Andrea Nixon
* 08/31/2020
* USD 159,882.00
...
funding in years beyond the grant.&lt;br/&gt;&lt;br/&gt;The Learning Assistant
model is a model for social and structural organization in undergraduate STEM
education that is related to and builds on the work of Peter Senge on learning
organizations and on the work of Jean Lave and Etienne Wenger on communities of
practice. It is an approach to supporting the growing use of evidence-based
instructional strategies. However, it is not a specific instructional strategy
but rather a method of training and using advanced undergraduate students as
course assistants and liaisons between instructors and students enrolled in a
STEM course. Built into the model is the baseline expectation that participating
institutions are working to bring about change in the way undergraduate courses
are taught and to study the effectiveness of these changes.