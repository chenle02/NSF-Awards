...
between number theory and dynamical systems, making it possible to rethink a
spectrum of possibilities for further work. This research project continues the
study of phenomena in both homogeneous dynamics and Diophantine approximation
related to asymptotic properties of orbits using those new ideas and methods.
Dynamical tools to be used are: quantitative non-divergence on the space of
lattices, Schmidt games and their modifications, recurrence of random walks and
integral inequalities, measure rigidity, effective mixing, and equidistribution
properties.
