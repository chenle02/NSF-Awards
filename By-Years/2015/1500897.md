...
understanding of instability mechanisms.&lt;br/&gt;&lt;br/&gt;The proposed
projects fall into the following three different fields. The first project is to
study Hamiltonian systems using symplectic methods. This will be a continuation
of previous work. It includes finding periodic orbits and homoclinic or
heteroclinic orbits satisfying certain topological constraints in non-convex
Hamiltonian systems. The next project is to try to use the methods of proving
Arnold diffusion to study systems in general relativity. The interest is in
showing Arnold diffusion in a perturbed Kerr-de Sitter metric and the physical
meaning of Arnold diffusion in this setting is the Penrose process for energy
and angular momentum extraction from black hole. In the last project the PI and
his collaborators will use a general dynamical system without Hamiltonian
