...
of a postdoctoral scholar and a graduate student in the research
project.&lt;br/&gt; &lt;br/&gt;Mathematically, these questions relate to the
question of the global solvability for the classical fluid equations: the Euler
and Navier-Stokes equations. The focus of this work will be on the problem of
singularity formation for the Euler equation. We will analyze the stability of
recently constructed examples of singularity formation and study the extent to
which these examples can be extended to give singularity formation for more
regular solutions. In parallel, we will consider the problem of enhanced
dissipation and study the effects of possible singular behavior in inviscid
problems on rapid dissipation in viscous problems.&lt;br/&gt;&lt;br/&gt;This
