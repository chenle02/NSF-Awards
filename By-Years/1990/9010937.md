...
only means to reconstruct subsistence. While, in practice, these techniques seem
to work well, the exact mechanisms by which elements are incorporated into
...
series of experiments. These include eleven controlled diet experiments using
small mammals fed naturally labeled carbohydrates and proteins in different
...
which to evaluate the results of the laboratory experiments. If time is
available, bone samples from prehistoric populations will also be examined. This
research is important because it will increase our basic understanding of the
nutritional process. It will yield analytic approaches of use in a wide variety
of archaeological situations.