...
project will develop a new seafloor sensor/sampler system to study how tides
affect the seafloor carbon cycle. It will also develop “smarter” control systems
to make predictions about when and where to best collect samples. This would be
a major improvement over existing approaches that waste battery power and have
short deployment times. These advances will also provide broader impacts by
providing technologies that can be applied to other sensor sets allowing them to
record data for longer periods. The project provides mentoring and field
opportunities to high-school and college students from a variety of backgrounds.
The team will work with an award-winning filmmaker to produce a short
documentary about careers in marine science.
