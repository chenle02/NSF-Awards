...
simplex knots using Thurston?s geometrical techniques, and the other plans to
...
groups using a new and simplified construction for it. Conway?s student Chris
...
Forms are closely related. Conway?s student W. Schneeberger is working on a
