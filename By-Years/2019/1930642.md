...
improve expectation visualization techniques. &lt;br/&gt;&lt;br/&gt;To do this,
the project has three main research goals. The first is to develop a suite of
empirical findings on the effects of expectation visualization, through a series
of experiments on how predicting data, receiving personalized feedback on those
predictions, and reflecting on gaps between predictions and data affect people's
later memory of the data and future expectations. The second thrust builds on
the first, using these empirical results along with design studies and
...
context and expert analysis with the visualization
