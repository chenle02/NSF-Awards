...
* 08/01/2013,08/03/2015
* Peter Glynn,CA,Stanford University
* Continuing Grant
* Leland Jameson
* 07/31/2017
* USD 209,999.00
...
mean field fixed point equations and Lyapunov stability. The PIs will
investigate a methodology that enables high-performance computing in the context
of simulation of stochastic systems. The PIs methodology will substantially
extend a recently developed approach, called Multilevel Monte Carlo (MLMC),
which has typically been applied only to compute numerical solutions of
stochastic differential equations (SDEs). More generally, this research project
addresses a wide range of problems that lie at the center of modern scientific
computing, beyond the important setting of SDEs which arise in virtually all
areas of modeling in engineering and science. For example, the PIs will
generalize the MLMC approach to accurately perform so-called steady-state
