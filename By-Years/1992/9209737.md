...
of white-tailed deer (Odocoileus virginianus). Their model is based on field
studies from northeastern Minnesota that indicate that adjacent wolf packs form
...
species: white-tailed deer. The field studies show that deer density is higher
...
system of coupled nonlinear partial differential equations, and describes the
