...
cohomology groups in some special cases. &lt;br/&gt; &lt;br/&gt;In this project,
one aspect is the study of the congruences modulo powers of p between
automorphic forms related to theta correspondence. This includes studying the
p-adic properties of certain theta lifts by using suitable integral
representations of L-functions and L-values for automorphic representations,
constructing certain p-adic L-functions and constructing Hida families of theta
lifts. The Iwasawa--Greenberg Main Conjecture predicts a connection between the
p-adic L-functions and the Selmer groups attached to p-adic deformations of
Galois representations. Another aspect of this project is to exploit the results
on the congruences to study this conjecture in the special case of the Rankin--
Selberg product of a pair of modular forms whose weights are of the same
parity.&lt;br/&gt;&lt;br/&gt;This award reflects NSF's statutory mission and has
