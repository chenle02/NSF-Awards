...
to facilitate the expanded measurement of VAMS across a larger scale.
&lt;br/&gt;&lt;br/&gt;This project has national significance as the use of VAMs
for teacher evaluation is expanding rapidly across the country in schools and
districts. A major objection to the use of VAMs in teacher evaluation has been
the over-reliance on the use of state testing data. Opponents of the use of VAMs
argue that this reliance contributes to a narrowing of curriculum and
