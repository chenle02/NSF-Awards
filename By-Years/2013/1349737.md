...
Categorization researchers have made an enormous contribution to the
understanding of the many ways in which knowledge can be represented and used. A
current challenge facing the field of categorization, and cognitive science more
generally, is how to best integrate these findings with the broader goal of
understanding the extent to which different types of knowledge representations
generalize to new situations. The proposed research utilizes a combination of
behavioral, neuroimaging, and computational modeling techniques to address these
challenges. Specifically, the investigators will explore (1) the factors
influencing the development of different types of category representations, (2)
the psychological functions and brain networks supporting category
representations, and (3) the utility of different types of category
representations for supporting performance in new tasks and/or with new stimuli.
In addition, this research will highlight important relationships between
machine learning techniques and methods used in cognitive science. As a result,
the research should be of broad interest to psychologists, computer scientists,
and the general cognitive science community.