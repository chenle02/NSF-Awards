...
This study concentrates on the dynamics of supercritical coastal buoyant plumes
that expand obliquely across the shelf. These buoyant plumes transport low
salinity waters across the continental shelf and can be entrained by ocean
currents flowing by the shelf’s edge. The buoyant plumes are influenced by the
balance between wind stress (upwelling-favorable) and buoyancy forcing. Tidal
pulses of brackish water interfere with such dynamic balance to produce radial
fronts referred to as sub-plumes. These sub-plumes are subsequently advected by
Ekman transport. Data collection will consist of 4 seasonal surveys of Winyah
Bay plume using ships (UNOLS ship requested), drones, Autonomous Surface
Vehicles, and a floating platform to obtain profiles of water velocity,
salinity, temperature, and turbulence properties. The sub-plume fronts shall be
ubiquitous as long as the horizontal density gradient is prominent and the
inertial period is greater than the tidal period. Observations will be
...
project will be a collaboration between and R1 and a teaching institution.
