...
The specific technical objective is a rigorous mathematical theory for
understanding random structures that exhibit relative exchangeability and other
invariance principles. A hallmark of the project is the in-depth study and
rigorous development of theory and applications for edge exchangeable network
models, which were first introduced by the PI as a novel invariance principle
for network analysis. Desired outcomes include relative invariance principles,
