...
techniques and novel dynamic scheduling methods.&lt;br/&gt; In this work, the
principal investigators develop new statistical techniques for analysis of
complex data sets which evolve over time. Of prime importance are the
relationships between variables hidden in the data, and these cannot often be
described by simple mathematical functions. Once discovered, these relationships
are used to describe the underlying physical causal phenomena and to predict
future observations. The specific application used in this proposal is the study
of the brightness time profiles of gamma-ray bursts (GRB), extremely large
cosmic explosions that occur daily in outer space. With the advent of quicker
and better GRB afterglow observations, astrophysical models are becoming more
