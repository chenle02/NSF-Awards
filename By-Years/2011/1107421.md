...
experiments in the Thule region with the following research objectives: 1)
Reconstruct Holocene climate in NW Greenland via inferences from reconstructed
local ice cap extents (North Ice Cap, Tuto Ice Cap), ice core stable isotope and
precipitation records, and data from nearby lake sediments. 2) Examine the
sensitivity of the NW Greenland Ice Sheet (GIS) to Holocene climate changes by
developing the history of the areal extent of the GIS and synthesizing proxy
data with glaciological modeling experiments to examine past GIS changes and
predict future GIS retreat. Results from the proposed research will enable a
more accurate prediction of the NW Greenland cryospheric response to a future
warmer world and provide information directly relevant to predictions of future
