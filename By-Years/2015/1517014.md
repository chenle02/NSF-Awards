...
astronomy.&lt;br/&gt;&lt;br/&gt;This program has three principal science goals.
(1) Search for circumplanetary disks around companions orbiting Herbig Ae/Be
stars: generate a uniform atlas of all archival high resolution M-band
observations of Herbig Ae/Be, search for variable CO emission indicative of an
orbiting companion, and obtain additional observations. (2) Search for dynamical
markers of massive substellar companions. (3) Apply this group's thermochemical
model to sources with observed OH and CO emission to test the hypothesis that OH
primarily arises from the inner rim of circumstellar disks.