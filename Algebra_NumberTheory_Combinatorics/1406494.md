...
http://www.math.colostate.edu/~hulpke/pingree/index.html.

Group theory is often described as the algebraic study of symmetry in the
...
cryptography. Geometry has always played a crucial role in understanding the
structure of groups, and over the last forty years machine computations have
been increasingly important to developments in both fields. The subject of the
conference is the interaction between theoretical questions concerning groups
and geometries and algorithmic questions arising from extensive machine
computation with these fundamental objects.
