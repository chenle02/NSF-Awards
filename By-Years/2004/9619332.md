...
9619332 COBURN This project will provide support for shipboard scientific
...
This project will allow the institution to replace two control vans for remotely
operated vehicles on the KNORR, obtain a satellite weather system for the KNORR,
Upgrade radars on the OCEANUS, obtain a GMDSS radio and a machinery vibration
monitoring system for the KNORR, replace workboats on the KNORR and OCEANUS and
obtain a Computer for the KNORR. ***