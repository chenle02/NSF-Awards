...
* Larry Hoyle, University of Kansas Center for Research Inc
* Standard Grant
* Daniel Katz
* 08/31/2015
* USD 35,235.00
...
Integrating citation information into an existing lifecycle metadata framework
will supply the foundation for metrics of impact of datasets, instruments and
procedures, as well as for their creators. It should also serve as the
foundation for tools to collect this information during the normal research
workflow. As these metrics become adopted in promotion and tenure decisions,
documenting data will increasingly be seen as an activity carrying a reward,
rather than as just burdensome overhead. This, in turn, should lead to better
documentation and more reusable, better quality data.