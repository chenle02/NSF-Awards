...
* DMS,STATISTICS
* 06/01/2023,12/28/2022
* Jason Klusowski,NJ,Princeton University
* Continuing Grant
* Yulia Gel
* 05/31/2028
* USD 84,472.00
...
This proposal aims to provide a comprehensive study of the statistical
properties of greedy recursive partitioning algorithms for training decision
trees, as is demonstrated in two fundamental contexts. The first thrust of the
project will develop a theoretical framework for the analysis of oblique
...
which require estimators with high pointwise accuracy.
