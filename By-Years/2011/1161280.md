...
* Jonah Blasiak, Regents of the University of Michigan - Ann Arbor
* Standard Grant
* Tomek Bartoszynski
* 05/31/2014
* USD 128,541.00
...
algebraic combinatorics as has been initiated by geometric complexity
theory.&lt;br/&gt;&lt;br/&gt;Objects arising in algebra are typically
complicated, mysterious, and have many symmetries. Algebraic combinatorics is
the study of counting and organizing such objects. This project will explore
some surprising connections between this area and complexity theory (the study
of algorithms and their limitations). The tensor decomposition problem is an
important and difficult problem that shows up in many fields, including
algebraic combinatorics, complexity theory, and statistics, and has applications
in medicine, computer vision, chemistry, and fast matrix multiplication.
Essentially, it is the problem of recovering individual signals from a mixture
of signals. This project offers potential new insights into this problem by
applying powerful tools from algebraic combinatorics.