...
0900177/0900018 Vainchtein/Grigoriev

The goal of this research program is to construct a general quantitative theory
of long-time resonance-driven chaotic transport and mixing in near-integrable
autonomous and non-autonomous volume-preserving flows. Specific examples of
microscale flows will be used to illustrate the general approach and develop
specific tools that can be naturally generalized to a wide class of volume-
preserving and Hamiltonian systems. The deterministic theory of resonance
