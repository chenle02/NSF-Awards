...
geochemical data, in particular isotopic and trace element abundances, we
propose a reinterpretation for the relationship between volcanism and tectonism
in southwest North America. The work here will test the hypothesis that the key
...
Farallon plate beneath SWNA. In this project, we test this hypothesis through
