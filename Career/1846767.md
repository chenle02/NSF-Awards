...
The research project consists of three parts. The first is an in-depth
exploration of the scissors congruence of polytopes as it relates to the
algebraic K-theory of the real and complex numbers. Using Rognes' stable rank
filtration the PI and collaborator Jonathan Campbell intend to construct maps
between the filtered parts of Rognes' filtration and the derived scissors
