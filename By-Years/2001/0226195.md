...
defined expandable-collapsible hierarchies.

An advisory board is providing oversight and guidance for the digital library:
(a) design and implementation; (b) evaluation strategies, including the design
of the questionnaire; (c) dissemination strategies, including website links as
well as CD-ROM distribution with and without cost-recovery; and (d) management
in a manner that fosters long-term sustainability. This project involves
