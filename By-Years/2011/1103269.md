...
of the spinor group and related groups.&lt;br/&gt;&lt;br/&gt;The unifying theme
in both proposed topics is to understand to what extent problems in algebraic
geometry can be linearized and studied using cohomology. The Hodge conjecture,
which motivates the first proposed topic, asks if cohomology determines
algebraic cycles. Similarly, the second proposed topic asks to what extent
cohomological invariants determine torsors. Since linear invariants are usually
more tractable than non-linear ones, both topics are of fundamental importance
in algebraic geometry and related subjects.