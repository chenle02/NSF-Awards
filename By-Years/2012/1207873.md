...
class group.&lt;br/&gt;&lt;br/&gt;Three-manifolds are a central object of
mathematical study for several reasons. The most obvious is that the space we
live in is a 3-manifold and one basic goal of mathematics is to gain a better
understanding of the real world. On a more abstract level, 3-manifolds have a
deep and intricate structure that connects to many other areas of mathematics.
This project will focus on hyperbolic 3-manifolds. When looking at the simplest
examples it first appears that hyperbolic 3-manifolds are quite rare. However, a
deeper analysis shows that, in a natural sense, hyperbolic 3-manifolds are the
most prevalent type of 3-manifolds. While 3-manifolds themselves are topological
objects to understand hyperbolic 3-manifolds them one is quickly led to algebra,
geometry and analysis. By studying hyperbolic 3-manifolds we learn more about
