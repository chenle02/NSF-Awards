...
factors that influence habitat use by generalist and specialist herbivores: two
species of rabbits. Tradeoffs among four habitat features (nutrients in food,
toxins in food, security cover, and thermal cover) will be measured in the
laboratory and under natural field conditions to model and compare the
functional importance of these features. The investigators will integrate
results to predict resource selection and infer habitat quality when organisms
are faced with complex decisions in natural environments.
