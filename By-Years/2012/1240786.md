...
over 200 U.S. teens, and a worldwide deployment of the website.

This project is part of a larger effort to increase both computing literacy and
interest in computing careers on the part of U.S. teens. This project's focus on
social learning is particularly important for broadening participation in
computing, allowing teens to learn computing in supportive and collaborative
settings, rather than the highly competitive settings that tend to deter many
teens today. Moreover, because the website will only require an Internet
connection and a web browser, and not software installations or special devices,
the project will also improve access to effective, evidence-based computing
education, reaching learners who only have Internet access at public libraries
or at school. These efforts will not only improve U.S. citizens' global
competitiveness for information technology jobs, but also help the broader
citizenry better understand and debug the increasingly software-based world
around them.