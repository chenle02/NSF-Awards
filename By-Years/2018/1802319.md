...
a suite of improved situational awareness tools that can seamlessly bridge the
cyber-physical layers of today's electricity delivery infrastructures. At the
bulk transmission level, we propose to revitalize the design of traditional
energy control center systems, in particular the topology processing and
security analysis modules, to jointly infer the cyber-physical operating states
and to efficiently evaluate the security impacts of potential cyber-physical
contingencies. As for small-footprint microgrids, we propose to investigate the
flexibility and vulnerability trade-offs between centralized and distributed
architectures in the presence of cyber-intrusions to communication links. Our
research plan consists of three cohesive thrusts: T1) Optimal topology inference
and cyber state estimation using a multitude of cyber-physical data; T2) Real-
time cyber-physical dynamic security assessment by developing the 'cyber-
contingency distribution factors' and model-free stability analysis methods; and
T3) Distributed microgrid operations under cyber-physical disturbances and
