...
9318446 Chang-Hasnain We propose a novel all-optical, self-routing switching
network based on an innovative address coding scheme. The proposed work includes
concerted research efforts at the network, systems and device levels. "All-
optical" switching is accomplished by tagging the data packet with an address
code consisting of a serial combination of wavelengths, so that switching can be
done simply by sensing the wavelength without the need for first converting the
high-speed data to electronic form. Self-routing is exercised by sensing the
