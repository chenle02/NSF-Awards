...
system Sage.&lt;br/&gt;&lt;br/&gt;The PIs will develop a stable (large rank)
limit of the spherical DAHA of Koornwinder type and use this study the
combinatorics of Koornwinder polynomials and their lifts to symmetric functions.
The aim is to prove foundational results on the stable Koornwinder DAHA and
apply these results to solve problems and outstanding conjectures in the
following areas:&lt;br/&gt;- Creation operators for Koornwinder polynomials,
with applications to Rains' integrality conjecture for Koornwinder symmetric
functions&lt;br/&gt;- Duality conjectures for DAHA torus knot polynomials of
non-reduced affine type and generalizations of the rational shuffle conjecture
beyond type A&lt;br/&gt;- Combinatorial formulas for Koornwinder polynomials in
the spirit and specializations of such formulas to classical affine root
systems&lt;br/&gt;- Specializations of Koornwinder symmetric functions to
q-deformed universal characters&lt;br/&gt;- Explicit formulas for symmetric
function operators arising from the stable DAHA