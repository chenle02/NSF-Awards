...
goal, we propose to incorporate optimistic exploration for online RL and
...
second goal, we propose to incorporate model selection into existing approaches
with the help of tight sample complexity
