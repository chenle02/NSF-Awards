...
connect students with the ideas and researchers in stable homotopy.



Using newly developed tools in equivariant stable homotopy, the PI will study
the slice spectral sequences for certain chromatically meaningful quotients of
hyperreal spectra. These are closely connected to the classical approaches to
studying K(n)-local phenomena using the Hopkins--Miller higher real K-theory
spectra, and at the prime 2, computations here subsume all previously known
higher real K-theory computations. The project focuses mainly on concrete
computations (both of chromatically meaningful quotients of hyperreal bordism
and of more traditional objects like the dual Steenrod algebra), while also
studying more abstract questions of what kinds of multiplicative structures we
can see. Finally, an application of all of this machinery to the classical
questions of orientability of vector bundles is explored.
