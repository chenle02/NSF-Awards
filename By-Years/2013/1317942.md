...
their subgraphs to properties of the colored Jones polynomial will be
studied.&lt;br/&gt;&lt;br/&gt;When studying objects that are embedded in three
dimensional space, e.g. knots, via their projections on a plane information
about the original object is lost and additional information is needed to
indicate which arc of the knot is farther away from the projection plane. By
projecting on other surfaces more information about the original object can be
preserved. These projections will be used to gain understanding of the
topological and geometrical properties of knot invariants like the Jones
polynomial.