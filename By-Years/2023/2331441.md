...
startups in the area of quantum information for chemistry and physics.

Technical Summary: The PIs propose a dedicated and multidisciplinary RAISE
program between quantum chemistry, theoretical computer science, and
computational condensed matter physics in the context of NSF's Quantum Algorithm
Challenge. A new quantum algorithm for such open systems, one that scales
favorably on quantum devices, would be transformative beyond the quantum-
computing community. The team notes the timeliness of the proposed approach: as
recently as 2019, researchers at Google and NASA presented heuristic
benchmarking showing that their 54-qubit superconducting circuit quantum
computer performs certain sampling algorithms much faster than classical
...
for the NSF RAISE program mandate.
