...
Science. &lt;br/&gt; &lt;br/&gt;The purpose of this research is to investigate
the importance of sea-level feedbacks in stabilizing marine-based ice sheets
during their retreat. The proposed investigation will combine new late
Pleistocene/Holocene relative sea-level constraints to be collected from raised
shorelines, existing offshore marine cores, and isolation basins from across
northwestern Scotland, to refine the glacial isostatic adjustment models for the
British Isles. The proposal will also investigate sea-level feedbacks at a more
local level and at the scale of the Late Pleistocene ice stream that once flowed
through the Minch of northwestern Scotland using a more specialized ice-sheet
model. This model, coupled with results from an improved “global” scale glacial
isostatic adjustment model for the British Isles, will be used to understand the
...
rheology of the Earth beneath it.&lt;br/&gt;&lt;br/&gt;This award reflects NSF's
