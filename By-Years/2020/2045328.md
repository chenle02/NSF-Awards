...
in applied mathematics and continued education.&lt;br/&gt;&lt;br/&gt;This
project builds a rigorous foundation for a new era of network-based mean field
game theory and applications. The first goal is to identify the range of network
structures for which the standard mean field approximation is valid, in order to
substantially extend the scope of the mean field paradigm. For those network
structures for which the standard mean field approximation fails, the second
goal is to identify and analyze tractable alternatives. Certain important
...
and new techniques must be developed to address these
