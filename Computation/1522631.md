...
design, sonar, radar and simulations of blood flow.

The numerical simulations under consideration in the proposed work will involve
the solution of linear boundary value problems. Many linear boundary value
problems can be recast as integral equations. Solution techniques based on
integral equations come with the cost of having to solve a dense linear system
upon discretization. Fast direct solvers invert a dense system by exploiting
