...
angiogenic treatments. The current project will be greatly beneficial for
&lt;br/&gt;a) reducing health care costs by replacing expensive and invasive
tests by analysis of medical images, and by shortening hospital stays for stroke
patients due to better monitoring of drug effectiveness;&lt;br/&gt;b) the
medical practice, since development of novel path-breaking methodologies for
analysis of DCE imaging data will potentially improve clinical outcomes by
providing non-invasive tools for cancer detection and characterization and for
longitudinal evaluation of therapeutic impact of anti-angiogenic treatments;
&lt;br/&gt;c) medical research, since the software for analysis of DCE imaging
data will be freely available to everyone who carries out examination of such
data and, thus, will contribute to design of new methodologies; &lt;br/&gt;d)
other types of medical imaging techniques, since methodologies resulted from the
proposal will contribute to understanding of reconstruction of sparse high-
dimensional functions in the presence of noise; and&lt;br/&gt;e) various fields
of science such as geophysics and astronomy, which rely on solution of noisy
inverse problems.&lt;br/&gt; &lt;br/&gt;The current project presents an integral
