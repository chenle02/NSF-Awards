...
9508085 Lall An understanding of the dynamics (or time evolution) of streamflow,
its predictability, causality and variability at different time and space scales
is a central issue in hydrologic research. The proposed research seeks to
develop quantitative notions of predictability and dynamical similarity of
streamflow at U.S. sites, using long USGS records (60 to 114 years) of daily
...
which we sample by streamflow. Similarly, climatic fluctuations that have
"structure " at long time scales, (e.g., El Nino Southern Oscillation). may
increase stearmflow predictability. An interesting methodology for insights into
such processes is provided by recent advances in nonlinear dynamics, and in
...
recovery of system invariants from the time series using nonparametric
