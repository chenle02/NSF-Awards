...
* Vinayak Rao,IN,Purdue University
* Continuing Grant
* Yong Zeng
* 07/31/2022
* USD 150,000.00
...
This project works in the overarching framework of Bayesian statistics, where
the primary object of interest is the posterior distribution over the unknown
parameters and variables. The research focuses on theoretical and methodological
challenges arising from approximate computation for Bayesian decision theory.
The investigators consider two complementary problems, (a) Decision-theoretic
