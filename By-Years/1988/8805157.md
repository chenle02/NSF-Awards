...
mathematical sciences. The equipment in this project is to be used for the
following projects: Symbolic Computations for the Variational Bicomplex; Local
Grid Curving Multilevel Techniques; Efficiency and Feasibility Studies of best
Approximation Algorithms; Numerical Simulation of Rotating Spiral Waves in
Excitable Media; Implementation Issues for the Karmarkar Algorithm; Least-change
Secant Update Methods for Parameter-dependent Equations; and Fast Algorithms for
Cluster Analysis.