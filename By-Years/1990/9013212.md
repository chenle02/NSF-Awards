...
for this work is to demonstrate the feasibility of reanalyzing past atmospheric
...
reanalysis of long term (more than 10 years) historical data sets for climate
research. The data assimilation system to be used will include the COLA general
circulation model, the forecast of which will provide the first guess, and the
most accurate optimum interpolation algorithm available. The observational data
set will be a combination of level II-data archived in real time during the
period and delayed mode data, including the comprehensive Ocean-Atmosphere Data
Set (COADS), which have been assembled at NCAR. The critical evaluations of the
...
outstanding example of ocean-atmosphere interaction as manifested by the E1
