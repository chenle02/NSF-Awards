...
augmented reality/virtual reality (AR/VR) applications process data from high-
definition sensors (such as cameras, motion sensors, and microphones) to enable
...
computing devices (such as IoT devices, AR/VR headsets, and drones). The outcome
of this project will advance data analytics and machine-learning research by
