...
subjects.&lt;br/&gt;&lt;br/&gt;A major role of mathematics is to provide a
framework or language to discuss processes of science. The framework developed
in this project centers on the concept of shape. In mathematics, Teichmuller
theory and moduli space theory is the study of the shapes that a surface can
assume. Geodesics in a space represent an efficient way of moving or evolving in
the space and the study of geodesics is central to geometry. Both Weil-Petersson
geodesics and Teichmuller geodesics describe natural and very different ways in
which the shapes of surfaces evolve efficiently over time. This project concerns
the study of this evolution under these two different processes.