...
&lt;br/&gt;&lt;br/&gt;(I). Provide conditions and examples for the assumption of
weak hypotheses to be valid, as well as some implications of the assumption on
the generalization error.&lt;br/&gt;(II). Further understanding of the
overfitting behavior and regularization methods in boosting.&lt;br/&gt;(III).
Bring together the important recent developments in the areas of regression
(e.g., thresholding) and classification (e.g., boosting), where increasingly
different sets of tools have been developed. &lt;br/&gt;&lt;br/&gt;Boosting
algorithms are very useful tools for combining simple prediction rules
