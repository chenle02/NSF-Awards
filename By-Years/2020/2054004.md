...
function or geometry being studied.&lt;br/&gt;&lt;br/&gt;More precisely, the
project focuses on Lipschitz (and related) mappings. Building on his recent
collaborative work, the principal investigator will study when Lipschitz
mappings into metric spaces can be decomposed into or well-approximated by
simpler mappings, like linear maps or maps that factor through trees. The
principal investigator then plans to apply these techniques to provide new
structural results on geometric objects defined through Lipschitz maps, like
distance spheres or medial axes. The principal investigator will also
...
understanding of the analysis and geometry of non-smooth
