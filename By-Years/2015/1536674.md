...
Recent results based on a limited set of observations indicate that the organic
matter (OM) associated with primary marine aerosol (PMA) produced by bursting
bubbles from breaking waves at the sea surface is comprised partly to wholly of
RDOC rather than OM of recent biological origin as has been widely assumed. The
injection of RDOC into the atmosphere in association with PMA and its subsequent
