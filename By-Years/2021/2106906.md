...
series.&lt;br/&gt;&lt;br/&gt;In more detail, this projects fits into the broad
goal of understanding groups that act on hyperbolic, or negatively curved,
spaces. This goal is approached in three distinct ways: first, through
understanding all actions of a given group on hyperbolic metric spaces; next,
through an in-depth study of two particular actions of big mapping class groups,
a class of groups in which there has recently been an explosion of interest; and
finally, by seeking to prove a strong stability result for quotients of
hierarchically hyperbolic groups, a class of groups which can be completely
described by their actions on hyperbolic metric spaces. Parts of this project
involve tools from other areas of mathematics, including descriptive set theory
and (often non-commutative) ring theory.&lt;br/&gt;&lt;br/&gt;This award
