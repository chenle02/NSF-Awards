...
myopically, without adaptation. The outcome of our study is a cohesive system
model for a cognitive sensors, endowed with a decision engine that can optimize
not only what to sample but also how to sample analog signals, leveraging on its
expected success in finding spectrum holes. The project will explore the
complexity of the overall architecture and, ultimately, evaluate the potential
benefits of a cognitive MAB-FRI receiver. By moving learning algorithms a step
closer to manage directly the data-acquisition interface to the physical world,
the research as broad implications in a variety of related sensing problems. The
project will also include activities to engage students in classrooms presenting
the basic mathematical tools used in this research and minorities in research
projects that contribute to advance the broad field of adaptive systems.