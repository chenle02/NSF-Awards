...
from this project made fully public via the web.

The evolution of a new paradigm, where the primary controls on SOM dynamics are
less dependent on molecular structure than on other soil and ecosystem
properties, has created a knowledge gap in our ability to predict the response
of SOM to environmental change. The relationships among shifting controls over
different SOM stabilization mechanisms, ranging from distal factors operating at
broad spatial scales (e.g., climate) to proximal controls operating at finer
spatial scales (e.g., soil physicochemical properties), are poorly defined.
