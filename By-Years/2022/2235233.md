...
presentation skills.&lt;br/&gt;&lt;br/&gt;This project focuses on soliton
dynamics for several well-known classical topological field theories in
mathematical physics. Three prime examples of topological solitons are at the
center of the investigation: kinks, vortices, and skyrmions in one, two, and
three space dimensions, respectively. Heuristically, these solitons owe their
stability to their topological underpinnings. However, the mathematical
justification of this intuition is still rather poorly understood and mostly
open. The overarching goal of the project is to establish asymptotic stability
results for these classical topological solitons, and thus to rigorously justify
the heuristics for their stability. Over the course of the project the
investigator also plans to move towards studying multi-soliton configurations in
these and related settings. Beyond the intrinsic interest in the fundamental
problems at the center of this project, their resolution will have significant
impact on the analysis of strong nonlinear interactions between solitons and
radiation in the context of many other nonlinear dispersive
