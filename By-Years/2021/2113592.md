...
climatic and environmental problems quantified by technical
methods.&lt;br/&gt;&lt;br/&gt;On a technical level, the PI will transform a
Gaussian space-time process into a count process having the desired marginal
distribution(s). The work will prove that this setup produces the most flexible
count structures achievable. Extensions involving non-Gaussian processes will be
explored and methods to fit the spatio-temporal model via maximum likelihood
techniques will be developed via particle filtering and sequential Monte Carlo
methods. Extensions to multivariate count time series and will be examined and
asymptotic inference for some setups will be studied. Space-time applications to
snow presence/absence trends in the Northern Hemisphere will be
