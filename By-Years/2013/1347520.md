...
Irvine.&lt;br/&gt;&lt;br/&gt;This project involves the development and field
testing of instrumentation for measuring key compounds in reactive Cl cycling
(Cl2, BrCl, HOCl, ClO, HCl, and ClONO2) as well as ancillary measurements (HOx,
NO2). These measurements will provide an estimate of Cl atom levels. It is
expected that study will eventually lead field observations on the island of
Bermuda in both clean marine air and in air impacted by North American outflow
of pollutants. The ultimate goal is to develop and validate models that can be
used to quantitatively assess the impact of reactive Cl cycling over the oceans
on the lifetime of methane and other hydrocarbons.