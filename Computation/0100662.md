...
In basic terms the Principal Investigator will look at certain types of
algebraic systems together with the actions of operators. Such a system is
called a module and it might have many dimensions in the sense of depending on
many variable. The operations may represent something like the geometric
rotation of points on a space. The project will concentrate on the
