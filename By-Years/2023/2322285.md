...
Sciences (ETAUS) funded project will advance the field of water quality
monitoring by developing a sensor that can monitor multiple water quality
parameters throughout the year and fill this knowledge gap. The goal for the
sensor development is to simultaneously measure parameters that are significant
