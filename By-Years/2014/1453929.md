...
students at all levels into the supported research.

The award will support research into two fundamental families of inventory
models. Lost sales inventory models with positive lead times are appropriate for
many applications, but have resisted solution due to the curse of
dimensionality. This has led to the use of incorrect models in many
applications, for example the use of models with backlogged demand when lost
sales models are more appropriate. If successful, the supported research will
create an algorithmic framework and supporting methodologies aimed at developing
efficiently implementable heuristics which provably perform nearly optimally as
more randomness is introduced into the problem, for example through longer lead
