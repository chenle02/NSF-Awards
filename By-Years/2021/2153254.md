...
students.&lt;br/&gt;&lt;br/&gt;The presence of lower-dimensional structures is
ubiquitous in the physical literature, either as a boundary of a domain or a
singular part of an evolution. Many problems in nonlinear partial differential
equations which are otherwise well understood pose significant challenges when
they are coupled with a moving interface, even in seemingly simple settings.
Besides the nonlinearity, the difficulty of the problem lies in its nonlocality,
in the sense that the behavior of solutions depends on the global geometry of
the free boundary. Dynamic free boundary problems face an additional difficulty
coming from the lack of a priori regularity of the free boundaries. By studying
the proposed problems, the Principal Investigator (PI) aims to develop general
methods to deal with such difficulties. The work of the project uses geometric
analysis as well as variational and probabilistic
