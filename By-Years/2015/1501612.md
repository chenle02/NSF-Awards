...
their careers. &lt;br/&gt;&lt;br/&gt;From a more technical point of view, the
current proposal aims to make significant advances in several long standing
mathematical problems such as the cohomology of character varieties, the
construction of knot invariants, and questions related to modularity in
enumerative geometry. The central idea of this work is that such problems are
naturally related to BPS states counting problems in string theory. Then string
duality ultimately leads to new and precise mathematical conjectures showing
that many such problems occur naturally in the context of motivic Donaldson-
Thomas invariants of Calabi-Yau threefolds. This provides new proof strategies
and opens new directions of research, unraveling further unexpected relations.
More concretely, the aim is to apply this strategy to the study of the
cohomology of wildly ramified character varieties, Khovanov-Rozansky invariants
for non-algebraic knots, and the relation between modular forms and Donaldson-
Thomas invariants of K3-fibered Calabi-Yau threefolds.