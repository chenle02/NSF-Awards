...
Specifically, proxy records will be generated and used (d13C, d18O, %CaCO3,
B/Ca, d11B) in combination with numerical modeling to determine natural recovery
times for carbon cycle processes, temperature, and surface ocean acidification.
The study will (1) provide fundamental insight into negative climate-carbon
cycle feedbacks, (2) address important gaps in data coverage and understanding
of Eocene hyperthermals, and (3) constrain critical parameter values needed for
