...
interface dynamics and shape optimizations.

The proposed research will contribute directly to a crucial mathematical and
computational part of many important applications in science and engineering,
from multiphase fluids, seismic imaging in petroleum engineering, inverse
scattering in wave propagation, high order nonlinear interface evolution found
in the study of solidification of fluids, to bio-mechanical applications. The
training of students and post-doctoral researchers provided by the proposed
research program will allow them to conduct research in highly inter-
disciplinary projects and bring state-of-the-art numerical analysis and
computational algorithms to the related areas.
