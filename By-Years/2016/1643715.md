...
outreach expert and two high school teachers.

Accurate prediction of sea-level contributions from Antarctica critically
requires understanding current melting and supraglacial lake conditions. This
project will quantify Antarctic surface melt and supraglacial lakes, and the
linkages between the two phenomena. Scatterometer data will enable generation of
a 19-year multi-sensor melt time series. Synthetic aperture radar data will
