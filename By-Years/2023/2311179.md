...
the presence of messy data. It seeks new methods for computing Frechet distance
that can be done quickly even for complicated curves. It also seeks ways to
extend the main mathematical ideas behind the Frechet distances to data types
