...
porous media flows will be created for pre-college classrooms.

This research will combine experimental and numerical techniques to describe the
effects of the physical porous structure, the flow/heat transfer boundary layer
(including a comparison between oscillation and non-oscillation) and the
variations in wettability from materials and manufacturing process.
Experimentally, naturally-occurring and engineered porous media will be scanned,
analyzed, and catalogued in a database, and an experimental platform will also
be designed and developed to study in situ oscillating and multiphase transport
phenomena inside porous media using the Neutron Imaging Facility at Oak Ridge
National Lab. This experimental work will be coupled with numerical simulations
through parallel development of a multiphase discrete Boltzmann method model and
a hybrid discrete/lattice Boltzmann method model to capture kinetic behaviors
and multiscale interactions, in order to elucidate the fundamental behavior of
oscillating multiphase thermofluidic phenomena and fluid-solid interactions. The
knowledge developed in this project will, in turn, be used to improve the design
of porous structures in a variety of energy applications, including thermal
storage in concentrated solar power plants, carbon retention in rock structures,
and fuel cells.
