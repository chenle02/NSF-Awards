...
&lt;br/&gt;&lt;br/&gt;The intertwined areas of arithmetic and geometric
combinatorics are the focus of this proposal. Three groups of related open
problems will be investigated. The first concerns the size of sets whose
Minkowski sums is contained in the group of non-zero quadratic residues modulo a
given prime. The second investigates distance and sum-product questions for
large subset of finite fields. The third is on obtaining a characterization of
sets that exhibit near maximum growth under repeated set
