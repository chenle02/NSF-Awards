...
&lt;br/&gt;&lt;br/&gt;This proposal aims to attack the problems described above
with tools from less concrete, often foundational fields (e.g., non-archimedan
geometry, algebraic stacks, non-abelian methods, perfectoids), with the goals of
proving new results on the generalized Fermat equation; developing techniques to
find, with certainty, all solutions to a given equation; developing techniques
to bound the number of solutions to a given equation; and building new tools
